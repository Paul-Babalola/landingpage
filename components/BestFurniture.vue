<template>
  ...
  >
    <!-- Left: Testimonial -->
    <div>
      <h2 class="md:text-[40px] text-2xl font-semibold text-gray-900 mb-6">
        The Best Furniture <br />
        Manufacturer Of Your Choice
      </h2>

      <!-- Testimonial Text -->
      <blockquote class="text-gray-900 mb-6 text-sm md:text-xl w-7/8">
        ...
        business exploree the future Furniture power is a software as services.
      </blockquote>
    </div>
