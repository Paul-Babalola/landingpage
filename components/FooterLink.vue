<template>
    ...
    <footer class="bg-gray-900 text-white pt-12">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Links -->
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-sm py-10">
          <div>
            <h3 class="font-semibold mb-4">Our Products</h3>
          ...
          <div>
            <h3 class="font-semibold mb-4">Top Features</h3>
            <ul class="space-y-2 text-gray-400">
          ...
          <div>
            <h3 class="font-semibold mb-4">Favourite Things</h3>
            <ul class="space-y-2 text-gray-400">
      ...
      <!-- Bottom -->
      <div class="text-center text-white-500 text-sm py-6 border-t border-gray-800">
